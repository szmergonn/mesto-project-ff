...
export const popupImage = document.querySelector('.popup_type_image .popup__image');
export const popupCaption = document.querySelector('.popup_type_image .popup__caption');
